...
export function ThemeToggle({ theme, onToggle }: ThemeToggleProps) {
  ...
  return (
    <button
      ...
      aria-label={label}
      title={label}
      className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg border border-anthracite-700 text-zinc-400 transition-colors hover:border-accent-500/50 hover:text-zinc-100 focus-visible:border-accent-400 focus-visible:outline-none lg:h-6 lg:w-6"
    >
      <svg
        viewBox="0 0 16 16"
        fill="none"
